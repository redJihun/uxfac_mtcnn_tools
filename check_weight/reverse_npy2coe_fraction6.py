...
def make_quant_list():
    ...
    for idx in range(256):
        quant_list.append(-2.0 + (0.015625 * idx))
    return quant_list
...
sram4 = open('converted_coe/fw6_sram4.txt', 'w')
sram5 = open('converted_coe/fw6_sram5.txt', 'w')
sram6 = open('converted_coe/fw6_sram6.txt', 'w')
pnet, rnet = data['pnet'], data['rnet']

# mul value
mul4_0, mul4_1, mul4_2, mul4_3, mul4_4, mul4_5, mul4_6, mul4_7, mul4_8, mul4_9 = 1, 1, 2, 2, 8, 2, 4, 4, 2, 4
mul5_0, mul5_1, mul5_2 = 8, 16, 32
mul6_0, mul6_1, mul6_2, mul6_3, mul6_4, mul6_5, mul6_6, mul6_7, mul6_8, mul6_9, mul6_10, mul6_11, mul6_12, mul6_13, \
mul6_14, mul6_15, mul6_16, mul6_17 = 1, 1, 1, 4, 1, 4, 128, 32, 4, 1, 4, 2, 4, 2, 4, 2, 16, 8
